...
db_url = "postgresql://postgres:postgres@localhost:5432/theia_e3"
...
def main():
    for day in tqdm(range(10, 14)):
        ...
        build_graph("attack_theia_day_" + str(day), start_timestamp, end_timestamp)
